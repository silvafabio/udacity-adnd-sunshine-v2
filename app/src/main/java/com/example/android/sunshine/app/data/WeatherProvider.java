...
public class WeatherProvider extends ContentProvider {
    ...
    public int update(
        ...
        switch (match) {
            case WEATHER:
                normalizeDate(values);
                rowsUpdated = sqLiteDatabase.update(WeatherContract.WeatherEntry.TABLE_NAME, values,
                        selection, selectionArgs);
                break;
            case LOCATION:
                rowsUpdated = sqLiteDatabase.update(WeatherContract.LocationEntry.TABLE_NAME, values,
                        selection, selectionArgs);
                break;
            default:
                throw new UnsupportedOperationException("Unknown uri: " + uri);
